...
export default function PaymentDetailPage() {
  ...
  const showForm = isPending || resubmitting;
  const displayedShippingFee = showForm
    ? shippingFeeKnown
      ? resolvedShippingFee ?? 0
      : null
    : payment.shipping_fee;
  const displayedTotal = showForm
    ? shippingFeeKnown
            ...
            <div className="space-y-6 py-2 text-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  {isRejected
                    ? "Your payment could not be verified. Please resubmit or contact us."
                    : payment.payment_status === "collected"
